console.log("Trigger.js v1.0.8");
console.log("Copyright (c) 2021 Steven Lei");
console.log("Released under the MIT License.");
console.log("https://github.com/triggerjs/trigger");
console.log("为了提高加载速度，已将Trigger.js的源码放在自己的服务器中。请点击链接访问该项目！！");
/*!
 * Trigger.js v1.0.8
...
// 为了提高加载速度，已将Trigger.js的源码放在自己的服务器中。请点击链接访问该项目！！
(() => {
    var t = {
            635: (t, e, r) => {
                'use strict';
                ...
                function o(t) {
                    if ('string' == typeof t) {
                        if (t.indexOf(',') > -1) {
                            ...
                            if (4 !== e.length)
                                throw new Error(
                                    'Bezier function expected 4 arguments, but got '.concat(
                                        e.length,
                                        '.'
                                    )
                                );
            ...
            234: (t, e, r) => {
                ...
                function n(t) {
                    return (
                        (t && ['cover', 'inset'].includes(t)) || (t = 'cover'),
                        t
                    );
                }
            },
            ...
            551: (t, e, r) => {
                ...
                function o(t) {
                    ...
                    var e = document.querySelector(
                        '['.concat((0, n.G)(), 'ref="').concat(t, '"]')
                    );
                    return !e || e.hasAttribute(''.concat((0, n.G)(), 'follow'))
                        ? null
                        : e;
                }
            },
            ...
            381: (t, e, r) => {
                ...
                function o() {
                    var t =
                        document.body &&
                        document.body.getAttribute('data-trigger-prefix');
                    t &&
                        (function (t) {
    ...
    (() => {
        ...
        function u(r, n, i) {
            ...
            var c = (function (t, r, n) {
                    ...
                    var o = t;
                    for (; (o = o.parentElement) !== document.body; )
                ...
                if ('--_' !== f) {
                    ...
                    (h = y ? (0, a.$p)(y, h) : h),
                        ...
                        g.values.length > 0 && !g.values.includes(b)
                            ? 'exact' === g.mode &&
                              ((t.lastValue = null), e.style.removeProperty(f))
                            : (void 0 !== m[b] && (b = m[b]),
                              v != b &&
        ...
        function f(e, r) {
            ...
            var n = (0, t.G)();
            document
                .querySelectorAll('['.concat(n, 'name]'))
                .forEach(function (t) {
